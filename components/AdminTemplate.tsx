...
const DynamicHeader = (props: DynamicHeaderProps) => {
  ...
  return (
    <Animated.View style={[styles.top_layer]}>
  ...
  return (
    <>
      <ScrollView
        ...
        // }}
      >
        <DynamicHeader value={scrollOffsetY}>{props.topLayer}</DynamicHeader>
        <View style={styles.content_layer}>{props.middleLayer}</View>
      </ScrollView>
    </>
  );
}
